...
* La console de ligne de commande générée de manière aléatoire et les mots de passe SSH sont stockés dans le fichier Passwords.txt du package de reprise.
