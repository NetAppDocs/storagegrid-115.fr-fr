...
sidebar: sidebar 
keywords:  
summary: 'Vous pouvez utiliser ces fichiers d"exemple pour agréger quatre interfaces physiques Linux en une seule liaison LACP, puis établir trois interfaces VLAN qui subtitent la liaison pour une utilisation en tant qu"interfaces réseau StorageGRID Grid, Admin et client.' 
---
...
[role="lead"]
Vous pouvez utiliser ces fichiers d'exemple pour agréger quatre interfaces physiques Linux en une seule liaison LACP, puis établir trois interfaces VLAN qui subtitent la liaison pour une utilisation en tant qu'interfaces réseau StorageGRID Grid, Admin et client.
