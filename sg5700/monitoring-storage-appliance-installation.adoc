...
---
= Surveillance de l'installation de l'appliance de stockage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Accédez à Grid Manager, approuvez le nœud de stockage en attente et terminez le processus d'installation de StorageGRID.
+
