...
La figure montre les deux contrôleurs SG5760, avec le contrôleur E2800 en haut et le contrôleur E5700SG en bas. Dans le SG5712, le contrôleur E2800 est à la gauche du contrôleur E5700SG, lorsqu'il est vue depuis l'arrière.
...
|===
. Connectez le port de gestion 1 (P1) du contrôleur E2800 (port RJ-45 sur la gauche) au réseau de gestion pour SANtricity System Manager à l'aide d'un câble Ethernet.
+
N'utilisez pas le port de gestion 2 (P2) sur le contrôleur E2800 (port RJ-45 sur la droite). Ce port est réservé au support technique.
