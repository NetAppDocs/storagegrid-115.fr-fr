...
---
= Affichage des codes de démarrage du contrôleur SG6000-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Si vous souhaitez utiliser une machine virtuelle basée sur un noyau (KVM), vous avez de l'expérience dans le déploiement et l'utilisation d'applications KVM.
