...
---
= Linux : ajout de volumes SAN ou DAS à un nœud de stockage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Vous devez avoir accès aux instructions d'installation de StorageGRID pour votre plate-forme Linux.
...
*** Saisissez *n* pour ignorer le reformatage. Les volumes de stockage sont formatés.
