...
* Vous ne pouvez pas démarrer la procédure de déclassement du site si une opération de réparation ec est en cours. Consultez la rubrique suivante pour effectuer le suivi des réparations de données avec code d'effacement.
+
